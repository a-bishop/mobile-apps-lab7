package ca.camosun.converterapp__lab7;
...
//        }
        addItem(createConverterItem(1, "Temperature", "toCelsius", "toFahrenheit"));
        addItem(createConverterItem(2, "Length", "toMetres", "toFeet"));
        addItem(createConverterItem(3, "Area", "toAcres", "toHectares"));
        addItem(createConverterItem(4, "Weight", "toKgs", "toLbs"));
    }
